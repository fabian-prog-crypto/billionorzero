...
## Main Sync Relevance Assessment (origin/main @ `28ff6b0`, 2026-02-13)
...
- Evidence: `src/app/equities/accounts/page.tsx:26`
...
- Evidence: `src/app/crypto/accounts/page.tsx:30`
...
- Status: Open
- Area: Crypto -> Wallets
- Evidence: `src/app/crypto/wallets/page.tsx:58`
...
- Evidence: `src/store/portfolioStore.ts:113`, `src/store/portfolioStore.ts:124`
...
- Status: Open
- Area: Cash -> Accounts
- Evidence: `src/app/cash/accounts/page.tsx:82`, `src/app/cash/accounts/page.tsx:100`
...
- Evidence: `src/app/api/portfolio/accounts/route.ts` (`matchesTypeFilter`)
