      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="card">
          ...
          <div className="flex gap-2 text-xs mt-1">
            <span className="text-green-600">L: {formatCurrency(exposureMetrics.longExposure)}</span>
            <span className="text-red-500">S: {formatCurrency(exposureMetrics.shortExposure)}</span>
          </div>
        </div>
        <div className="card">
        ...
        <div className="card">
          ...
          <p className={`text-xl font-semibold ${
            exposureMetrics.leverage > 2 ? 'text-red-500' :
            exposureMetrics.leverage > 1.5 ? 'text-yellow-600' : ''
          }`}>
          ...
          <div className="p-4 bg-[var(--background-secondary)] rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-green-600">{formatCurrency(spotDerivatives.spotLong)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--foreground-muted)]">Short (Borrowed)</span>
                <span className="text-red-500">{formatCurrency(spotDerivatives.spotShort)}</span>
              </div>
          ...
          <div className="p-4 bg-[var(--background-secondary)] rounded-lg">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex justify-between">
                ...
                <span className="text-green-600">{formatCurrency(spotDerivatives.derivativesLong)}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-[var(--foreground-muted)]">Short Notional</span>
                <span className="text-red-500">{formatCurrency(spotDerivatives.derivativesShort)}</span>
              </div>
              <div className="flex justify-between">
      ...
      <div className="card mb-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div>
            ...
            <p className={`text-lg font-semibold ${concentrationMetrics.top1Percentage > 30 ? 'text-yellow-600' : ''}`}>
          ...
          <div>
            ...
            <p className={`text-lg font-semibold ${
              concentrationMetrics.herfindahlIndex > 2500 ? 'text-red-500' :
              concentrationMetrics.herfindahlIndex > 1500 ? 'text-yellow-600' : ''
            }`}>
        ...
        <div className="card mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
            ...
            <div className="p-4 bg-[var(--background-secondary)] rounded-lg">
              ...
              <p className={`text-lg font-semibold ${perpsMetrics.netNotional >= 0 ? 'text-green-500' : 'text-red-500'}`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="flex justify-between text-sm">
              <span className="text-[var(--foreground-muted)]">Long Notional</span>
              <span className="text-green-500">{formatCurrency(perpsMetrics.longNotional)}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-[var(--foreground-muted)]">Short Notional</span>
              <span className="text-red-500">{formatCurrency(perpsMetrics.shortNotional)}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className={perpsMetrics.marginAvailable < perpsMetrics.collateral * 0.2 ? 'text-yellow-600' : ''}>
